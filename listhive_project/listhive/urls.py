...
urlpatterns = [
    ...
    path('lists/create', views.ListCreateView.as_view(), name='list-create'),
    path('lists/update/<int:list_id>', views.ListUpdateView().as_view(), name='list-update'),
    path('lists/delete/<int:list_id>', views.ListDeleteView().as_view(), name='list-delete'),
    path('lists', views.ListList.as_view(), name='list-list'),
    path('lists/<int:pk>', views.ListDetail.as_view(), name='list-detail'),
    path('listitems/create', views.ListItemCreateView.as_view(), name='listitem-create'),
    ...
    path('trackers/create', views.TrackerCreateView.as_view(), name='tracker-create'),
